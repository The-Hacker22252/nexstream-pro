    ...
    if process_btn:
        if not url_input:
            ...
            if not video_id:
                ...
                # Setup clean Python string variables to inject into the HTML below
                ...
                # FIXED: Rewrote template structure to use strict JavaScript escaping syntax, preventing Python f-string confusion!
