...
if process_btn:
    if not url_input:
        ...
        try:
            ...
            # RE-ENGINEERED FORMATTING: Drops strict mp4/m4a labels to accept any available stream combination
            ydl_opts = {
                ...
                'format': 'bestvideo+bestaudio/best', # Stripped [ext=mp4] requirements to fix the format block
                'extractor_args': {
                    'youtube': {
                        'player_client': ['web'],
                        'player_skip': ['js']
            ...
            elif quality == "Best Available (Requires FFmpeg)" and FFMPEG_AVAILABLE:
                # Force FFmpeg to seamlessly repackage different streams into an unblocked MP4 container container shell
